function state_dot = rocket_ode(time, state, vehicle, env, uncertainties)
...
%acceleration
    ...
    m = mass(time, vehicle, uncertainties);
    moi = MOI(m, vehicle);
    
    CP = CP_rel_base(uncertainties);
    CG = CG_rel_base(vehicle, time, uncertainties);
    ...
    f_aero = aerodynamics.f_a(...
        v_apparent_rocket,...
        time,...
        vehicle,...
        env,...
        uncertainties);
    f_thrust = f_t(roll_axis, time, vehicle, env, uncertainties);
